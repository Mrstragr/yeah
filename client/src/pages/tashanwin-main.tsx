          ...
          <div>
            ...
            <div className="container mx-auto px-4 py-6 space-y-6">
              ...
              <div className="bg-red-900 p-6 rounded-lg space-y-4">
                ...
                <div className="overflow-x-auto">
                  <div className="flex space-x-4 pb-4" style={{minWidth: 'max-content'}}>
                    ...
                    <div className="bg-yellow-600 p-6 rounded-lg text-center min-w-[200px] hover:bg-yellow-500 transition-colors cursor-pointer" onClick={() => openGame('Coin Flip')}>
                    ...
                    <div className="bg-yellow-600 p-6 rounded-lg text-center min-w-[200px] hover:bg-yellow-500 transition-colors cursor-pointer" onClick={() => openGame('Dice Roll')}>
                      <div className="text-5xl mb-3">🎲</div>
                    ...
                    <div className="bg-yellow-600 p-6 rounded-lg text-center min-w-[200px] hover:bg-yellow-500 transition-colors cursor-pointer" onClick={() => openGame('Scratch Cards')}>
                      <div className="text-5xl mb-3">🎫</div>
                    ...
                    <div className="bg-yellow-600 p-6 rounded-lg text-center min-w-[200px] hover:bg-yellow-500 transition-colors cursor-pointer" onClick={() => openGame('Roulette')}>
                      <div className="text-5xl mb-3">🎡</div>
                    ...
                    <div className="bg-yellow-600 p-6 rounded-lg text-center min-w-[200px] hover:bg-yellow-500 transition-colors cursor-pointer" onClick={() => openGame('Blackjack')}>
                      <div className="text-5xl mb-3">🃏</div>
              ...
              <div className="bg-gradient-to-r from-purple-900 to-blue-900 p-6 rounded-lg space-y-4 border-2 border-purple-400">
                ...
                <div className="overflow-x-auto">
                  <div className="flex space-x-4 pb-4" style={{minWidth: 'max-content'}}>
                    <div className="bg-green-600 p-8 rounded-lg text-center min-w-[250px] hover:scale-105 transition-all cursor-pointer border-2 border-white" onClick={() => openGame('Plinko')}>
