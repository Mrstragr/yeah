    ...
    <div className="min-h-screen bg-casino-primary">
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <div style={{backgroundColor: "red", color: "white", padding: "20px", fontSize: "24px"}}>
          TEST - CLASSIC CASINO GAMES SHOULD DISPLAY HERE
        </div>
        
        <div style={{backgroundColor: "purple", color: "white", padding: "20px", fontSize: "24px"}}>
          TEST - NEW GAMES SHOULD DISPLAY HERE
        </div>
